...
const ProjectsListing = ({ projectsList }) => {
  return (
    <div className="mp_projectsListing-container">
      <h4 className="mp_font2">Showing {projectsList.length} projects :-)</h4>
          ...
          <div className="mp_project-card" key={index}>
            ...
            <div className="mp_pc-subcontainer2">
              ...
              <div className="mp_pc-subcontainer22 mp-vertically-fc">
                ...
                {project?.code.split(",").map((codeLink, index) => (
                  <a
                    key={index}
                    rel="noreferrer"
                    href={codeLink}
                ...
                {project?.features && (
                  <a rel="noreferrer" href={project.features} target="_blank">
